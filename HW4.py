...
# model_relu.add(Dense( n_hidden_start1, activation='relu', kernel_initializer= 'he_normal'))
# model_relu.add(Dense(int(n_hidden_start1 / 2), activation='relu',kernel_initializer= 'he_normal'))
# model_relu.add(Dense(int(n_hidden_start1 / 4), activation='relu',kernel_initializer= 'he_normal'))
#
# model.add(Dense( n_hidden_start2, activation='relu', kernel_initializer= 'he_normal'))
# model.add(Dense(int(n_hidden_start2 / 2), activation='relu',kernel_initializer= 'he_normal'))
# model.add(Dense(int(n_hidden_start2 / 4), activation='relu',kernel_initializer= 'he_normal'))
#
# model.add(Dense( n_hidden_start3, activation='relu', kernel_initializer= 'he_normal'))
# model.add(Dense(int(n_hidden_start3 / 2), activation='relu',kernel_initializer= 'he_normal'))
# model.add(Dense(int(n_hidden_start3 / 4), activation='relu',kernel_initializer= 'he_normal'))

model_relu.add(Flatten(input_shape = (32,32,1)))
model_relu.add(Dense(n_hidden_start1, activation='relu',kernel_initializer= 'he_normal'))
model_relu.add(Dense(n_hidden_start2, activation='relu',kernel_initializer= 'he_normal'))
model_relu.add(Dense(n_hidden_start3, activation='relu',kernel_initializer= 'he_normal'))
...
new_a_model.add(Dense(n_hidden_start1, activation='sigmoid',kernel_initializer= 'he_normal'))
new_a_model.add(Dense(n_hidden_start2, activation='sigmoid',kernel_initializer= 'he_normal'))
new_a_model.add(Dense(n_hidden_start3, activation='sigmoid',kernel_initializer= 'he_normal'))
...
new_a_model.compile(loss='categorical_crossentropy', metrics=['accuracy'], optimizer='adam')
...
if not("loss_and_metrics" in os.listdir()):
    os.mkdir("loss_and_metrics")
save_dir = "loss_and_metrics/"
model_name = "final_weights25.h5"
...
new_a_model.add(Dense(n_hidden_start1,kernel_initializer= 'he_normal'))
new_a_model.add(layers.BatchNormalization())
...
new_a_model.add(Flatten(input_shape = (32,32,1)))
new_a_model.add(Dense(n_hidden_start1, activation='relu', kernel_initializer= 'he_normal'))
new_a_model.add(Dense(n_hidden_start1 / 2), activation='relu',kernel_initializer= 'he_normal')
new_a_model.add(BatchNormalization())
new_a_model.add(Dense(int(n_hidden_start1 / 4), activation='relu',kernel_initializer= 'he_normal'))

new_a_model.add(Dense( n_hidden_start2, activation='relu', kernel_initializer= 'he_normal'))
new_a_model.add(Dense(int(n_hidden_start2 / 2), activation='relu',kernel_initializer= 'he_normal'))
new_a_model.add(BatchNormalization(axis=1))
new_a_model.add(Dense(int(n_hidden_start2 / 4), activation='relu',kernel_initializer= 'he_normal'))

new_a_model.add(Dense( n_hidden_start3, activation='relu', kernel_initializer= 'he_normal'))
new_a_model.add(Dense(int(n_hidden_start3 / 2), activation='relu',kernel_initializer= 'he_normal'))
new_a_model.add(BatchNormalization(axis=1))
new_a_model.add(Dense(int(n_hidden_start3 / 4), activation='relu',kernel_initializer= 'he_normal'))
